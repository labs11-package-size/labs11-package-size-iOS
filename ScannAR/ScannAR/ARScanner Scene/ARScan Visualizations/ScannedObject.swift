...
class ScannedObject: SCNNode {
    ...
    func fitOverPointCloud(_ pointCloud: ARPointCloud) {
        ...
        let hitTestResults = sceneView.hitTest(ARScanViewController.instance!.screenCenter, types: .featurePoint)
    ...
    private func updateOrCreateGhostBoundingBox() {
        // Perform a hit test against the feature point cloud.
        guard let result = sceneView.smartHitTest(ARScanViewController.instance!.screenCenter) else {
