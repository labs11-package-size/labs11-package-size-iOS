//
//  SmallToLargeInteractiveAnimator.swift
//  ScannAR
//
...
class SmallToLargeViewInteractiveAnimator: UIPercentDrivenInteractiveTransition {
    ...
    @objc func onPan(_ pan: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            if shouldComplete {
                (fromViewController as? SmallToLargeAnimatable)?.prepareBeingDismissed()
                finish()
            }
        case .ended:
