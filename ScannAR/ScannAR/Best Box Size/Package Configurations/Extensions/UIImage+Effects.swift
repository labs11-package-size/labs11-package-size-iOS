...
public extension UIImage {
    func applyBlurWithRadius(_ blurRadius: CGFloat, tintColor: UIColor?, saturationDeltaFactor: CGFloat, maskImage: UIImage? = nil, completion: @escaping (_ result: UIImage?) -> Void) {
        ...
        if hasBlur || hasSaturationChange {
            ...
            guard let effectInContext = UIGraphicsGetCurrentContext() else { return  completion(nil)  }
            ...
            guard let effectOutContext = UIGraphicsGetCurrentContext() else { return   completion(nil) }
        ...
        guard let outputContext = UIGraphicsGetCurrentContext() else { return  completion(nil) }
